...
exports.WalletRazorpayCreation  =async(req,res)=>{
try{
...
exports.WalletConfirmPayment = async (req, res) => {
    try {
...
exports.withdrawMoney = async (req, res) => {
    try {
      const userId = req.session.user_id;// Assuming you're using authentication middleware to get the user ID
