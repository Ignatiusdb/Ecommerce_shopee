                        ...
                        <div class="media-body">
                            ...
                            <ul class="list-inline list-inline-dotted mb-3 mb-lg-2">
                                <li class="list-inline-item">
                                    <a href="#" class="text-muted" data-abc="true">Status: ${item.status}</a>
                                </li>
                                <li class="list-inline-item">
                            ...
                            ${
                                order.status === 'Canceled'
                                    ? `<p class="text-danger" id="cancellationMessage">
                                            ...
                                            </svg> Order has been canceled.<span style="font-size: 13px;">${order.requests && order.requests.length > 0 && order.requests[0].status === 'Pending' ? '(Amount will be refunded shortly.)' : '(Amount Refunded)'}</span>
                                        </p>`
                                    : order.status === 'Returned' && order.requests[0].status === 'Pending'
                                    ? `<p class="text-info" id="returnMessage">
                                            Order has been returned.<span style="font-size: 12px;">(Amount will be refunded shortly)</span>
                                        </p>
                                       `
                                    : order.status === 'Returned' && order.requests[0].status === 'Accepted'
                                    ? `<p class="text-success" id="returnMessage">
                                            Order has been returned successfully.<span style="font-size: 12px;">Amount refunded.</span>
                                        </p>`
